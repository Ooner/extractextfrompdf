...
var filePath = path.join(__dirname, 'yeni.pdf');
...
extract(filePath, function (err, pages) {
   ...
   // find max banner of each page
    for (i in countofBanner) {
    	...
    	var max = countofBanner[i][bannername+0];
    	var indexOfbanner = bannername+0;
    	
    	// console.log(bannername+0);
    	for (j in banner) {
